            ...
            <FormControl fullWidth>
                ...
                <Box paddingBottom={0.5}>
                    <Typography>
                        Nat Traversal via:{' '}
                        <Link
                            href="https://github.com/AsterZephyr/Scree-go-AZlearn#nat-traversal"
                            target="_blank"
                            rel="noopener"
                        >
                            {mode.toUpperCase()}
    ...
    return (
        ...
        >
            ...
            <div style={{position: 'absolute', margin: '0 auto', bottom: 0}}>
                Scree-go-AZlearn {config.version} |{' '}
                <Link href="https://github.com/AsterZephyr/Scree-go-AZlearn/">GitHub</Link>
            </div>
        </Grid>
    );
};
